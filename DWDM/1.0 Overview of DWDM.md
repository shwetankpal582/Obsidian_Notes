...
3. IOT Devices 
	1. Data From IOT devices

4. Social Media
	1. Information from social platforms (fb.insta.etc)

5. Spreadsheet / Flat files
	1. Simple file formats like excel sheet or CSV files

6. Production Data
	1. Includes data of operations and productions running in an organisation

7. Internal Data
	1. Includes all the data related to internal activities 